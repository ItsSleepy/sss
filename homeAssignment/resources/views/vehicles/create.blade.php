                ...
                <form action="{{ route('vehicles.store') }}" method="POST">
                    @csrf <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="model_name" class="form-control bg-dark text-light border-secondary" placeholder="e.g. M1A2 Abrams" value="{{ old('model_name') }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="unit_cost" class="form-control bg-dark text-light border-secondary" placeholder="1000000" value="{{ old('unit_cost') }}" required min="0">
                            </div>
                        </div>
                    </div>
